...
$tabBar.on('click', 'li', function (e) {
  ...
  .addClass('active').siblings() // .css({ display: 'none' })
  //注意 这是行为和样式绑定的行为不建议使用
  .removeClass('active');
  $li.addClass('selected').siblings().removeClass('selected'); //只使用js控制css的增减而不能直接操作css样式
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7919" + '/');
